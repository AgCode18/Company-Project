                        ...
                        <form>
                            ...
                            <div className="mb-5">
                                ...
                                <div className="flex border border-gray-300 rounded-lg overflow-hidden focus-within:border-indigo-500 transition-colors">
                                    ...
                                    <input type="number" placeholder="" className="flex-1 px-3 py-3 text-sm outline-none" />
                                </div>
                            </div>
                            ...
                            <button type="submit" className="w-full py-3.5 bg-[#883AFD] text-white rounded-lg text-sm cursor-pointer transition-all hover:-translate-y-0.5 hover:shadow-[0_10px_20px_rgba(99,102,241,0.3)]" >
                                Send message
                            </button>
                        </form>
                    </div>
